...
class PromoCodeModel {
  ...
  Map<String, dynamic> toJson() {
    return {
      'name': name,
      'discount': discount,
      'discountType': discountType?.toString(), // Safely handle null enum
      'startDate': startDate,
      'endDate': endDate,
      'isActive': isActive,
  ...
  factory PromoCodeModel.fromSnapshot(DocumentSnapshot snapshot) {
    ...
    return PromoCodeModel(
        ...
        // Enum Parsing Safeguard
        discountType: data['discountType'] != null
            ? DiscountType.values.firstWhere((element) => data['discountType'] == element.toString())
            : null,
        ...
        // Safe Number Parsing (prevents num to double cast crashes)
        minOrderPrice: double.tryParse(data['minOrderPrice'].toString()) ?? 0.0,
